...
| `docs/harness-engineering.md`| Los pilares del arnés y el patrón de orquestación multi-agente              | Para entender cómo se coordina el trabajo |
...
## 4. Flujo de trabajo (SDD dentro del arnés)
